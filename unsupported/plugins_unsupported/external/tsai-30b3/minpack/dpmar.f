...
c
c     Machine constants for the IEEE double precision floating point.
c     taken from values of dmach(4), dmach(1) and dmach(2) in d1mach.f,
c     generated by machar.f from the BLAS distribution in Netlib.
c
