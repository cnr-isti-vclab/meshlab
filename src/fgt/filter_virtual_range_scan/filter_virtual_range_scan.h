...
private:
    ...
    virtual void setupComplete      ( VRSParameters* currentParams );
    virtual void povProcessed       ( int povIndex, int samplesCount );
    virtual void texturesDownloaded ( void );
    virtual void fillingTargetMesh  ( int samplesCount );
    vcg::CallBackPos* cbBackup;
    VRSParameters vrsParams;
    int totSamples;
