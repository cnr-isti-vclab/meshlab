...
public:
    ...
    virtual bool applyFilter(QAction *, MeshDocument &, const RichParameterSet &, vcg::CallBackPos *);
    virtual bool applyFilter(QAction *, MeshModel &, const RichParameterSet &, vcg::CallBackPos *) { assert(0); return false; }
