...
{ 
    typeList << FP_PLYMC << FP_MC_SIMPLIFY;
 ...
 QString PlyMCPlugin::filterName(FilterIDType filterId) const 
{
  ...
  case FP_MC_SIMPLIFY :  return QString("Simplfication: MC Edge Collapse");
		default : assert(0); 
	}
}
 ...
 QString PlyMCPlugin::filterInfo(FilterIDType filterId) const
{
  ...
  case FP_MC_SIMPLIFY :  return QString(
 ...
 PlyMCPlugin::FilterClass PlyMCPlugin::getClass(QAction *a)
{
  ...
  case FP_MC_SIMPLIFY :  return MeshFilterInterface::FilterClass(MeshFilterInterface::Remeshing + MeshFilterInterface::Cleaning);
		default : assert(0); 
	}
  ...
  case FP_MC_SIMPLIFY:
    {
      ...
      tri::MCSimplify<CMeshO>(mm.cm,0.0f,false);
