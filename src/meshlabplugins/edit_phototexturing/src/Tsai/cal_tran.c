...
void      undistorted_to_distorted_sensor_coord_cp_cc (struct camera_parameters *cp, struct calibration_constants *cc, double Xu, double Yu, double *Xd, double *Yd)
{
#define SQRT3   1.732050807568877293527446341505872366943
...
void      world_coord_to_image_coord_cp_cc (struct camera_parameters *cp, struct calibration_constants *cc, double xw, double yw, double zw, double *Xf, double *Yf)
{
    double    xc,
              yc,
              zc,
    ...
    /* convert from undistorted to distorted sensor plane coordinates */
    undistorted_to_distorted_sensor_coord_cp_cc (cp,cc,Xu, Yu, &Xd, &Yd);
