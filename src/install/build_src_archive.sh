...
#
find meshlab code/lib/glew sf | egrep -v  -e CVS -e /ui_ -e build -e /moc_ -e /qrc_ -e /test/ -e MeshLabBundle -e docs/ -e /web/ -e /apps/ -e\# | egrep -e  [.]cpp$ -e [.]c$ -e  [.]h$ -e  [.]pro$ -e [.]ui$ -e [.]png$ -e [.]qrc$ -e [.]vert$ -e [.]frag$ -e [.]gdp$ -e [.]txt$ -e [.]icns$ -e images/100mesh.html> list.txt
#
