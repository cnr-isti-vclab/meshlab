...
#if ! defined (__GMP_WITHIN_CONFIGURE)
#define __GMP_CC "gcc" 
#define __GMP_CFLAGS "-m32 -O2 -fomit-frame-pointer -mtune=core2 -march=core2 -mno-cygwin" 
#define __MPIR_CC "gcc -std=gnu99"
#define __MPIR_CFLAGS "-m32 -O2 -fomit-frame-pointer -mtune=core2 -march=core2 -mno-cygwin"
#endif
