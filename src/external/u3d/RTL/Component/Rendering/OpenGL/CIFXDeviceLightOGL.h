...
//
//***************************************************************************
// CIFXDeviceLightOGL.h
#ifndef CIFX_Device_LIGHTOGL_H
#define CIFX_Device_LIGHTOGL_H
...
// CIFXDeviceLight
//==============================
class CIFXDeviceLightOGL : public CIFXDeviceLight
{
	U32 m_refCount;
public:
	U32 IFXAPI  AddRef ();
	...
	friend IFXRESULT IFXAPI_CALLTYPE CIFXDeviceLightOGLFactory(IFXREFIID intId, void** ppUnk);

	//=================================
	// CIFXDeviceLightOGL methods
	//=================================
	CIFXDeviceLightOGL();
	~CIFXDeviceLightOGL();

	IFXRESULT IFXAPI Initialize(U32 uIndex, IFXOpenGL* pOGL);
...
protected:
	...
	U32 m_uIndex;
	IFXVector4 m_vPosition;
	IFXVector3 m_vDirection;
	IFXMatrix4x4	m_mModelViewMatrix;
	
	IFXOpenGL* m_pOGL;
};
typedef IFXSmartPtr<CIFXDeviceLightOGL> CIFXDeviceLightOGLPtr;
