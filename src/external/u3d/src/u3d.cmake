...
IF(WIN32)
  ...
  ADD_LIBRARY( external-IDTFConverter STATIC ${IDTFConverter_SRCS} ${IDTFConverter_HDRS} IDTF/IDTFConverter.rc IDTF/IFXResource.h)
ENDIF(WIN32)
IF(APPLE)
...
IF(UNIX AND NOT APPLE)
  ADD_LIBRARY( external-IDTFConverter ${IDTFConverter_SRCS} ${IDTFConverter_HDRS} )
  target_link_libraries( external-IDTFConverter IFXCoreStatic ${CMAKE_DL_LIBS} )
ENDIF(UNIX AND NOT APPLE)
TARGET_LINK_LIBRARIES( external-IDTFConverter ${ADDITIONAL_LIBRARIES} )
