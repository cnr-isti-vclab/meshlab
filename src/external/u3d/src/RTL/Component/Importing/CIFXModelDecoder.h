...
//	CIFXModelDecoder.h
//
//		Declaration of the CIFXModelDecoder.
//		The CIFXModelDecoder is used by the CIFXLoadManager to load
//		model nodes into the scene graph. CIFXModelDecoder exposes an
//		IFXDecoderX interface to the CIFXLoadManager for this purpose.
//
//*****************************************************************************
#ifndef CIFXMODELDECODER_H__
#define CIFXMODELDECODER_H__
...
class CIFXModelDecoder : virtual public IFXDecoderX,
						 public CIFXNodeBaseDecoder
{
private:
	// Member functions.
    CIFXModelDecoder();
	virtual ~CIFXModelDecoder();

public:
	// Factory function.
	friend IFXRESULT IFXAPI_CALLTYPE CIFXModelDecoder_Factory( IFXREFIID interfaceId, void** ppInterface );
