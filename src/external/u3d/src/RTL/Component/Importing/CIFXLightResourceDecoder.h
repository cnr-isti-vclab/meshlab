...
//***************************************************************************
//
//	CIFXLightResourceDecoder.h
//
//		Declaration of the CIFXLightResourceDecoder.
//		The CIFXLightResourceDecoder is used by the CIFXLoadManager to load
//		light nodes into the scene graph. CIFXLightResourceDecoder exposes an
//		IFXDecoderX interface to the CIFXLoadManager for this purpose.
//
//*****************************************************************************
#ifndef CIFXLightResourceDecoder_H
#define CIFXLightResourceDecoder_H
...
class CIFXLightResourceDecoder : virtual public IFXDecoderX,
						 public CIFXNodeBaseDecoder
{
public:
	// Factory function.
	friend IFXRESULT IFXAPI_CALLTYPE CIFXLightResourceDecoder_Factory( IFXREFIID interfaceId, void** ppInterface );
...
private:
	// Member functions.
    CIFXLightResourceDecoder();
	virtual ~CIFXLightResourceDecoder();
