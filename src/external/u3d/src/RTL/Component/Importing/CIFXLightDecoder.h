...
//	CIFXLightDecoder.h
//
//		Declaration of the CIFXLightDecoder.
//		The CIFXLightDecoder is used by the CIFXLoadManager to load
//		light nodes into the scene graph. CIFXLightDecoder exposes an
//		IFXDecoderX interface to the CIFXLoadManager for this purpose.
//
//*****************************************************************************
#ifndef CIFXLIGHTDECODER_H
#define CIFXLIGHTDECODER_H
...
class CIFXLightDecoder : virtual public IFXDecoderX,
						 public CIFXNodeBaseDecoder
{
private:
	// Member functions.
    CIFXLightDecoder();
	virtual ~CIFXLightDecoder();

public:
	// Factory function.
	friend IFXRESULT IFXAPI_CALLTYPE CIFXLightDecoder_Factory( IFXREFIID interfaceId, void** ppInterface );
