...
/**
  @file IFXSchedulingDllMain.cpp

		This module defines for IFXScheduling the main Windows DL entry 
		point.  It should be placed in the Platform/IFXScheduling/Win32 
		folder.
*/
                        ...
                        LPVOID		pReserved )
{
    ...
    if ( reason == DLL_PROCESS_ATTACH )
    {
		...
		result = IFXSchedulingStartup();
    }
    else if ( reason == DLL_PROCESS_DETACH )
    {
		result = IFXSchedulingShutdown();
    }
