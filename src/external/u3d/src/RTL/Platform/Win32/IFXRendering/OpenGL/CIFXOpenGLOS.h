...
//***************************************************************************
// CIFXOpenGLOS.h
#ifndef CIFX_OPENGL_WIN_H
#define CIFX_OPENGL_WIN_H

#include "CIFXOpenGL.h"

class CIFXOpenGLOS : virtual public IFXOpenGLOS, public CIFXOpenGL
{
	U32 m_refCount;
public:
	friend IFXRESULT IFXAPI_CALLTYPE CIFXOpenGLOSFactory(IFXREFIID intId, void** ppUnk);
...
protected:
	...
	virtual IFXOGLPROC IFXAPI GetOpenGLFunc(char* szFuncName);
	virtual IFXOGLPROC IFXAPI GetOGLExtensionFunc(char* szFuncName);

	static CIFXOpenGLOS* ms_pSingleton;

	IFXHANDLE m_hLibrary;
};
