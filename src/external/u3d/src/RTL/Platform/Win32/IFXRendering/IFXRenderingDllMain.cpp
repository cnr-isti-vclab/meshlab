...
/**
  @file IFXRenderingDllMain.cpp

		This module defines for IFXRendering the main Windows DL entry 
		point.  It should be placed in the Platform/IFXRendering/Win32 
		folder.
*/
